...
const schema = z.object({
  ...
  employmentStatusVisible: z.boolean().optional(),
  genderVisible: z.boolean().optional(),
  stateOfOriginVisible: z.boolean().optional(),
    ...
    { _id: new ObjectId(session.user.id) },
    {
      $set: {
        profile: {
          ...
          employmentStatusVisible: data.employmentStatusVisible ?? false,
          genderVisible: data.genderVisible ?? false,
          stateOfOriginVisible: data.stateOfOriginVisible ?? false,
